...
// reads photo into memory of the server (temporary)
exports.upload = multer(multerOptions).single('photo');

// resizes the photo for storage, needs a next since it is as middleware
exports.resize = async (req, res, next) => {
  // check if there is no new file to resize
  if (!req.file) {
    next(); // skips to the next middleware if no file
    return;
  }
